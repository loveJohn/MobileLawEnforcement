...
/**
 * 
 * @ClassName HisPatrolViewGroup
 * @Description TODO
 * @author leix@geo-k.cn
 * @date 2014年6月12日 上午10:37:00
 * 
 */
public class HisPatrolViewGroup extends FrameLayout {
	...
	public HisPatrolViewGroup(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(context);
	}

	public HisPatrolViewGroup(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
