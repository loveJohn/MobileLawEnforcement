...
/**
 * 
 * @ClassName PatrolView
 * @Description TODO
 * @author leix@geo-k.cn
 * @date 2014年6月12日 上午10:36:43
 * 
 */
public class PatrolView extends FrameLayout {
	...
	public PatrolView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(context);
	}

	public PatrolView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	void initView(Context context) {
		...
		rootView = LayoutInflater.from(context).inflate(R.layout.view_patrol,
				null);
	...
	public void setTitle(String title) {
		...
		Log.i("ydzf", "PatrolView_setTitle="+title);
	}
