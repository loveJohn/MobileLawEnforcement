...
/**
 */
public class PatrolEditeView31 extends FrameLayout {
	...
	public PatrolEditeView31(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(context);
	}

	public PatrolEditeView31(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}

	public PatrolEditeView31(Context context) {
		super(context);
		initView(context);
	}
	...
	void initView(Context context) {
		try {
			...
			LinearLayout lll = (LinearLayout) rootView
					.findViewById(R.id.lll_patro_edit);
	...
	void viewPatrolInfo(String id, String table) {
		try {
			...
			if (patrolValues != null && patrolValues.size() > 0) {
				Log.i("ydzf", "PatrolEditView31_viewPatrolInfo");
	...
	OnClickListener viewClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.view_patrol_edite_redline:
				Log.i("ydzf","PatrolEditeView31_redline_Button_press");
