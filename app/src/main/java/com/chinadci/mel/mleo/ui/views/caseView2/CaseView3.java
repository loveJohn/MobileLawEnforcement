...
public class CaseView3 extends FrameLayout {
	...
	public CaseView3(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(context);
	}

	public CaseView3(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	public void setDataSource(String id, String caseTable, String annexTable,
			String jcbh, String jcmj,String zygdmj, String xfsj,String fxjg) {
		this.caseId = id;
		this.caseTable = caseTable;
		this.annexTable = annexTable;
		// display case detail info
		viewCaseInfo(this.caseId, this.caseTable, this.annexTable, jcbh, jcmj, zygdmj, xfsj, fxjg);
	}
	...
	void viewCaseInfo(String id, String cTable, String aTable, String jcbh,
			String jcmj, String zygdmj, String xfsj,String fxjg) {
		try {
			String columns[] = new String[] { InspectionCaseTable.field_id,
			...
			if (caseInfo != null) {
				...
				values[2] = jcbh;
				values[3] = jcmj;
				values[4] = zygdmj;		//add teng.guo
				values[5] = caseInfo.getAsString(InspectionCaseTable.field_address);
				values[6] = xfsj;
				values[7] = fxjg;
				// values[5] = caseInfo
				...
				keys[2] = "监测编号";
				keys[3] = "监测面积";
				keys[4] = getContext().getString(R.string.v_f44);
				keys[5] = getContext().getString(R.string.v_f5);
				keys[6] = "下发时间";
				keys[7] = "一张图分析结果";
				// keys[5] = getContext().getString(R.string.v_f7);
				// keys[6] = getContext().getString(R.string.v_f8);
	...
	void showRedline() {
		if (redlineJson != null && !redlineJson.equals("")) {
			...
			Intent intent = new Intent(parentActivity, MapViewActivity2.class);
			...
			// intent.putExtra("jctbUrl", R.string.uri_jctbUrl);
