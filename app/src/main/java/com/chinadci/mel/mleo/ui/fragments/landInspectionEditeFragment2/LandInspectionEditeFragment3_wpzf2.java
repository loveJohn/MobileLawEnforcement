...
public class LandInspectionEditeFragment3_wpzf2 extends
		LandCaseViewpagerFragment2 {
	...
	private String keyDeal;		//add teng.guo
	
	private String glbh;
	
	private String clqk;		//add teng.guo 处理情况
	...
	public void handle(Object o) {
		...
		if (tag == 0) {
							...
							new android.content.DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
						            ...
						            if (input.equals("")) {  
						            	...
						            	//key值 2为退回。
						                upLoadReason("2",currentUser,TimeFormatFactory2.getSourceTime(new Date()),input,caseId,"");	//退回处理,不做转立案处置操作,zlacc置""值,
						            }  
								}
			...
			final View view = factory.inflate(R.layout.dialog_edit_view, null);
			final EditText edit = (EditText) view.findViewById(R.id.editText);
			if(isZLACC()){		//判断处理情况，如果为转立案
				view.findViewById(R.id.text_view_tips).setVisibility(View.VISIBLE);
				new AlertDialog.Builder(getActivity())
						...
						new android.content.DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
					            ...
					            if (input.equals("")) {  
					            	...
					            	//key值1为同意
					            	input=(new StringBuffer("【转立案】")).append(input).toString();	//add teng.guo 20170704
					            	upLoadReason("1",currentUser,TimeFormatFactory2.getSourceTime(new Date()),input,caseId,"1");		//是，转入转立案查处系统，zlacc置"1"
					            }
							}
						}
				).setNegativeButton(
						...
						new android.content.DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
					            ...
					            if (input.equals("")) {  
					            	...
					            	//key值1为同意
					            	input=(new StringBuffer("【转立案】")).append(input).toString();	//add teng.guo 20170704
					            	upLoadReason("1",currentUser,TimeFormatFactory2.getSourceTime(new Date()),input,caseId,"0");		//否，转入已办理，zlacc置"0"
					            }
							}
						}).create().show();
			}else{	//非转立案
						...
						new android.content.DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
					            ...
					            if (input.equals("")) {  
					            	...
					            	upLoadReason("1",currentUser,TimeFormatFactory2.getSourceTime(new Date()),input,caseId,"");		//非转立案，不做转立案处置操作,zlacc置""值,
					            }
							}
						}).setNegativeButton("取消", null).create().show();
			}
	...
	protected void upLoadReason(String key,String spry,String spsj,String spsm,String caseId,String zlacc) {
		SubmitSpTask taSpTask = new SubmitSpTask(getActivity(), new TaskResultHandler<Boolean>() {
			@Override
		...
		taSpTask.execute(key,spry,spsj,spsm,caseId,zlacc);
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		clqk=intent.getStringExtra("clqk");
	...
	private void makeFg2() {
		...
		patrolEditeView.setDataSource(currentUser, caseId, CasePatrolTable.name);
	}
	...
	private void makeFg3() {
		...
		Log.i("ydzf","LandInspectionEditeFragment3_wpzf2_makeFg3");
		...
		caseInfoView.setMapStatusChangedListener(new OnStatusChangedListener() {
			...
			public void onStatusChanged(Object source, STATUS status) {
				try {
					...
					Log.i("ydzf","LandInspectionEditeFragment3_wpzf2_makeFg3_mapStatusChange");
