...
public class FJWMTSMapLayer_ extends TiledServiceLayer {
	File cacheFolder;
//	static String url = "http://service.fjmap.net/TianDiVector/wmts";
	static String url = "http://service.fjmap.net/cva_fj/wmts";
	static String url2 = "http://t1.tianditu.com/cva_c/wmts";

	public FJWMTSMapLayer_() {
		super(url);
		initLayer();
	}

	public FJWMTSMapLayer_(File cacheFolder) {
		super(url);
