...
public class InspectionView2 extends FrameLayout {
	...
	public InspectionView2(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(context);
	}

	public InspectionView2(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}

	public InspectionView2(Context context) {
		super(context);
		initView(context);
	}
