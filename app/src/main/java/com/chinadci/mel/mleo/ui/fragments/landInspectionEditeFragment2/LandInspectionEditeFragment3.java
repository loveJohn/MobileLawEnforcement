...
public class LandInspectionEditeFragment3 extends LandCaseViewpagerFragment2 {
	...
	void initFragment() {
		Log.i("ydzf", "LandInspectionEditeFragment3_initFragment");
		try {
			viewList.clear();
			makeFg3();
			makeFg2();
	...
	private void makeFg3() {
		...
		Log.i("guoteng","LandInspectionEditeFragment3_makeFg3");
		...
		caseInfoView.setMapStatusChangedListener(new OnStatusChangedListener() {
			...
			public void onStatusChanged(Object source, STATUS status) {
				try {
					...
					Log.i("guoteng","LandInspectionEditeFragment3_makeFg3_mapStatusChange");
