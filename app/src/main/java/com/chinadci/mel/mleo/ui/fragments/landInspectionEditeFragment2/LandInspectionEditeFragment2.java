...
import com.chinadci.mel.mleo.ui.views.caseView2.CaseView2;
...
import com.chinadci.mel.mleo.ui.views.patrolEditeView2.PatrolEditeView2;
...
public class LandInspectionEditeFragment2 extends LandCaseViewpagerFragment2 {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		contentView = inflater.inflate(R.layout.fragment_case_viewpager2,
				container, false);
	...
	void initFragment() {
		Log.i("ydzf", "LandInspectionEditeFragment2_initFragment");
		try {
			viewList.clear();
			makeFg3();
			makeFg2();
	...
	// MyViewPagerAdapter pagerAdapter = new ViewPagerAdapter(viewList,
	// titleList){};
	...
	private void makeFg2() {
		patrolEditeView = new PatrolEditeView2(context);
	...
	private void makeFg3() {
		caseInfoView = new CaseView2(context);
		...
		caseInfoView.setMapStatusChangedListener(new OnStatusChangedListener() {
			...
			public void onStatusChanged(Object source, STATUS status) {
				try {
					...
					Log.i("guoteng","LandInspectionEditeFragment2_makeFg3_mapStatusChange");
